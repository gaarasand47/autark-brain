...
```text
Gen-0 Body → Gen-1 Mind → Gen-2 Instinct → Gen-2A Perception/Learning
→ Gen-3 Builder → Gen-4 Operator → Gen-5 Enterprise
→ Gen-6 Family/Society → Gen-7 Constitutional Autonomous Society
```
...
1. The supplied status estimate (`60–65%`, `30–35%`, `10–15%`) is strategic
